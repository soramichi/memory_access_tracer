...
LIBS_PERF="${LINUX_SRC_DIR}/tools/perf/libperf.a ${LINUX_SRC_DIR}/tools/lib/traceevent/libtraceevent.a"
LIBS_STD="-lm -lpthread -ldl -lelf -lunwind -lunwind-x86_64"

g++ -std=c++11 -shared -fPIC hash.cpp -o hash.o
gcc -L . hash.o $CFLAGS mat.c $LIBS_PERF $LIBS_STD -o mat -D__PERF_VERSION_4__
