...
LINUX_SRC_DIR=`find ${SRC_DIR} -maxdepth 1 -name "linux-4.9*" | head -n 1` # use the first one anyway, this adds a bit of generality (e.g. 4.9.4 vs 4.9.5)
...
LIBS_PERF="${LINUX_SRC_DIR}/tools/perf/libperf.a ${LINUX_SRC_DIR}/tools/lib/traceevent/libtraceevent.a ${LINUX_SRC_DIR}/tools/lib/api/libapi.a ${LINUX_SRC_DIR}/tools/lib/subcmd/libsubcmd.a ${LINUX_SRC_DIR}/tools/perf/tests/attr.o ${LINUX_SRC_DIR}/tools/perf/pmu-events/pmu-events.o"
LIBS_STD="-lm -lpthread -ldl -lelf -lunwind -lunwind-x86_64 -lz"
